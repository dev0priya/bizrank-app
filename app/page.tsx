...
export default async function DashboardPage() {
  try {
    ...
    console.error('Root dashboard database error:', error);
    return (
      <div style={{ padding: '40px', maxWidth: '600px', margin: '60px auto', textAlign: 'center', background: 'rgba(255, 255, 255, 0.02)', border: '1px solid rgba(255,255,255,0.05)', borderRadius: '12px', backdropFilter: 'blur(20px)' }}>
